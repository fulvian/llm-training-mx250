#!/usr/bin/env python3
"""
Script per training di un modello italiano ultra-compatto con FLAN-T5-Small
Modello: google/flan-t5-small (80M parametri, multilingue)
...
def main():
    ...
    OUTPUT_DIR = "./italian-flant5-qlora-output"
    LEARNING_RATE = 2e-4
    BATCH_SIZE = 1
    ...
    # Step 4: Configurazione LoRA per FLAN-T5
